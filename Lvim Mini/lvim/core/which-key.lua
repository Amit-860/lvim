    ...
    lvim.builtin.which_key = {
        ...
        setup = {
            ...
            window = {
                ...
                margin = { 2, 28, 5, 32 }, -- extra window margin [top, right, bottom, left]
        ...
        mappings = {
            ...
            ["c"] = { "<cmd>BufferKill<CR>", "which_key_ignore" },
...
M.setup = function()
    ...
    wk.register({
        ["/"] = { "<Plug>(comment_toggle_linewise_visual)", "Comment toggle linewise (visual)" },
    }, { mode = "v", prefix = "<F12>", buffer = nil, silent = true, noremap = true, nowait = true, })
    wk.register({
        a = { "<cmd>lua vim.lsp.buf.code_action()<cr>", "Code Action" },
        d = { "<cmd>Telescope diagnostics bufnr=0 theme=get_ivy<cr>", "Buffer Diagnostics" },
        D = { "<cmd>Telescope diagnostics theme=get_ivy<cr>", "Workspace Diagnostics" },
        f = { require("lvim.lsp.utils").format, "Format" },
        ["/"] = { "<Plug>(comment_toggle_linewise_current)", "Comment Toggle" },
        j = {
            vim.diagnostic.goto_next,
    ...
    wk.register({
        ...
        m = { "<cmd>Telescope vim_bookmarks<cr>", "Global Bookmarks" },
        F = { "<cmd>loadview<cr>", "Load Folds" },
        f = { "<cmd>mkview<cr>", "Save Folds" },
    }, { prefix = "<tab>" })
    ...
    wk.register({
        r = {
            function()
                ...
                vim.api.nvim_command("CompileAuto")
            end, "Run"
        },
