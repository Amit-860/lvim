    ...
    lvim.builtin.which_key = {
        ...
        mappings = {
            ...
            d = {
                ...
                R = { "<cmd>lua require'dap'.restart()<cr>", "Toggle Repl" },
                s = { "<cmd>lua require'dap'.continue()<cr>", "Start" },
                q = { "<cmd>lua require'dap'.close()<cr>", "Quit" },
                U = { "<cmd>lua require'dapui'.toggle({reset = true})<cr>", "Toggle UI" },
                T = { "<cmd>lua require'dap'.terminate()<cr>", "Terminate" },
                B = { "<cmd>lua require'dap'.clear_breakpoints()<cr>", "Terminate" },
            },
            P = {
                name = "Plugins",
...
M.setup = function()
    ...
    which_key.register({
        ["\\"] = {
            ...
            w = { "<cmd>Telescope spell_suggest<cr>", 'Word Correction' },
        },
        ...
        r = {
            ...
            f = { "<CMD>RunFile toggleterm<CR>", "Run File" },
        },
        c = {
            name = "API call",
            c = { "<Plug>RestNvim", "Rest Nvim" },
            p = { "<Plug>RestNvimPreview", "Rest Nvim Preview" },
            r = { "<Plug>RestNvimLast", "Rest Nvim Last" },
        },
