...
if vim.g.neovide then
    ...
    vim.o.guifont = "JetBrainsMono Nerd Font Mono:h10.25"
    ...
    lvim.builtin.telescope.defaults.winblend = 40
    lvim.builtin.which_key.setup.window.winblend = 40
    lvim.builtin['terminal'].float_opts.winblend = 40
...
vim.keymap.set({ "n", "o", "x" }, "gh", '_', { noremap = true, silent = true, desc = "Goto first Non-whitespace char" })
...
formatters.setup({
    ...
    },
    {
        ...
        filetypes = { "scss", "css", "html", "yaml", "json", "toml" },
    },
    -- {
    --     command = "prettierd",
    ...
    --     filetypes = { "json", "javascript", "typescript", "javascriptreact", "typescriptreact" },
    -- },
})
...
linters.setup({
    ...
    {
        command = 'codespell',
        filetypes = { "javascript", "python", "json", "typescript", "typescriptreact", "javascriptreact", "bson" },
        extra_args = { "lint", "--json" }
    }
})
...
local emmet_ls_opts = {
    ...
    filetypes = { "html", "javascript", "typescript", "typescriptreact", "javascriptreact", "css", "scss" },
    init_options = {
        html = {
            options = {
